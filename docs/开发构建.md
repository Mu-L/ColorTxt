...
│   │   └── reader-textures/  # 内置阅读区背景图（URL `/reader-textures/`；目录项见 readerBuiltins/textures.ts）
│   └── src/
│       ├── main.ts           # 挂载 Vue 应用
